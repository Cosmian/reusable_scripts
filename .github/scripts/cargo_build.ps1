...
function BuildProject {
    ...
    if ($repo -eq "Cosmian/kms")
    {
        Get-ChildItem cli\crate\cli
    }
    if ($repo -eq "Cosmian/cli")
    {
        Get-ChildItem crate\cli
    }

    if ( $repo -eq "Cosmian/kms" -or $repo -eq "Cosmian/cli")
    {
    ...
    [elseif (repo -eq "Cosmian/findex-server")
    {
        # Check dynamic links
